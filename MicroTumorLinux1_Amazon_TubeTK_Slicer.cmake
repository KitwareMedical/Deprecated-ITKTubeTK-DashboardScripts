...
set( SITE_NAME "MicroTumorLinux1.Amazon.Slicer" )   
...
set( TubeTK_SOURCE_DIR
  "/home/ubuntu/src/dashboards/ITKTubeTK-Slicer-Src-${SITE_BUILD_TYPE}" )
set( TubeTK_BINARY_DIR
  "/home/ubuntu/src/dashboards/ITKTubeTK-Slicer-Build-${SITE_BUILD_TYPE}" )
...
set( Slicer_DIR "/home/ubuntu/src/Slicer-SuperBuild-Release/Slicer-build" )
...
set( USE_SYSTEM_ITK ON )  # From Slicer
#set( ITK_DIR "" )
...
set( USE_SYSTEM_SLICER_EXECUTION_MODEL ON )  # From Slicer
